...
**WildLens** is a dynamic, **cloud-native web application** that serves as a portfolio for wildlife photography.  
...
> 🧩 Built with **AWS Lambda**, **Amazon S3**, **Amazon RDS**, **Amazon EC2**, and **Node.js**,  
> this project demonstrates a **modern full-stack, serverless workflow** for user-generated content.
